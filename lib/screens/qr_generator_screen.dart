      ...
      pw.MultiPage(
        ...
        build: (pw.Context context) {
          return [
            pw.Header(
              level: 0,
              child: pw.Text('Badges QR Code Élèves - PetitPas', style: pw.TextStyle(fontSize: 18, fontWeight: pw.FontWeight.bold)),
            ),
      ...
      pw.MultiPage(
        ...
        build: (pw.Context context) {
          return [
            pw.Header(
              level: 0,
              child: pw.Text('Fiches QR Code Ateliers - PetitPas', style: pw.TextStyle(fontSize: 18, fontWeight: pw.FontWeight.bold)),
            ),
            pw.SizedBox(height: 20),
            pw.GridView(
              crossAxisCount: 2,
